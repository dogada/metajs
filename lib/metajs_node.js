...
var readSimple = (function(token, stream) {
  ...
  } else if (istring__QUERY(token.value)) {
...
(function() {
  var G__5 = metajs;
  G__5.stripDoubleQuotes = stripDoubleQuotes;
})();
...
(function() {
  var G__9 = metajs;
  G__9.compile = compile;
  G__9.translate = translate;
  G__9.jsLiteral = jsLiteral;
  G__9.jsSymbol = jsSymbol;
})();
...
setScopeMacro("include", null, (function(file) {
  ...
  var withDirAndFile = (function(dir, file, role, func) {
    var scope = getScope();
    return (function() {
      var G__10 = metajs.dir,
    G__11 = metajs.file,
    G__12 = metajs.fileRole,
    G__13 = scope.source;
      return (function() {
        try {
          metajs.dir = dir;
